                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <tr>
                                    <th colspan='6' style="text-align: center;">No Results</th>
                                </tr>
                            </tbody>
                        </table>
                        <div class="form-group col-md-4 text-left mb-3">
                            ...
                            <a href="${pageContext.request.contextPath}/logout" class="btn btn-primary btn-sm" style="background-color: green;">Logout</a>
                        </div>
                    </div>
                </div>
            </main>            
